<template>
  <div class="m-4">
    <span style="padding-bottom: 20px;  color: blue;" v-if="clientInfo.protocolType==='http'">Tips: HTTP协议的设备为异步获取结果, 推送后需要等待心跳返回</span><br>
    <br/>
...
<script lang="ts" setup>
  ...
  import { formSchema } from './lan.data';
  ...
  const params = {
        ...
        taskCode: DeviceTaskCodeEnum.lanCfg,
  ...
  async function handleSubmit() {
    ...
    if (values.lan_ipaddr === undefined || values.lan_ipaddr === '') {
